...
| tree | s | settings popup: h/l or ←/→ cycle the selected setting — theme, side padding (applies live and is written to the config file); j/k pick the row; Esc, Enter, or s closes |
